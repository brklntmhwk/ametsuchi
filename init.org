...
(use-package dashboard
  ...
  :demand t
  :custom
  (dashboard-banner-ascii "天地 卍 Ametsuchi")
  (dashboard-banner-logo-title
   "Ametsuchi is the universe—It encompasses (almost) everything that forms my ideal Emacs\
workstation, a living cosmos where creativity, logic, and intuition intertwine.")
