...
(use-package modus-themes
  ...
  (modus-themes-headings
   '((1 . (variable-pitch rainbow bold 1.6))
     (2 . (variable-pitch rainbow bold 1.5))
     (3 . (variable-pitch rainbow semibold 1.4))
     (4 . (variable-pitch rainbow semibold 1.3))
     (5 . (variable-pitch rainbow semibold 1.2))
     (6 . (variable-pitch rainbow semibold 1.1))
     (t . (1.1))))
...
(use-package org-modern
  ...
  ;;  '(((string #x265a) . (string #x2654)) ; King
  ;;    ((string #x265b) . (string #x2655)) ; Queen
  ;;    ((string #x265c) . (string #x2656)) ; Rook
  ;;    ((string #x265d) . (string #x2657)) ; Bishop
  ;;    ((string #x265e) . (string #x2658)) ; Knight
  ;;    ((string #x265f) . (string #x2659)))) ; Pawn
