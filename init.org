...
(defvar emacs-pictures-dir
	(let ((pics-dir (xdg-user-dir "PICTURES")))
		(if (string-empty-p pics-dir)
				"~/Pictures/"
			(concat pics-dir "/emacs/"))))

(defvar emacs-documents-dir
	(let ((docs-dir (xdg-user-dir "DOCUMENTS")))
		(if (string-empty-p docs-dir)
				"~/Documents/"
			(concat docs-dir "/emacs/"))))
#+end_src
**** custom
#+begin_quote
