...
(use-package fontaine
  ...
  (fontaine-presets
   '((regular
      ...
      :variable-pitch-family "Sarasa Gothic"
...
(use-package org-agenda
  ...
  (mapc (lambda (k) (keymap-unset org-agenda-mode-map k))
        '("TAB" "<tab>"))
  ;; Set it to "o" because it's the only small letter key
  ;; vacant in `org-agenda-mode-map'.
  ;; (It's bound to `delete-other-windows' precisely, but I don't use it)
